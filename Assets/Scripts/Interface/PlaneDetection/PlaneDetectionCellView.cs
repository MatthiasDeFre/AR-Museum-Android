...
public class PlaneDetectionCellView : EnhancedScrollerCellView
{
    public Image selectionPanel;
    /// <summary>
    /// Reference to the underlying data driving this view
    /// </summary>
    private PlaneDetectionCellData _data;
    ...
    /// </summary>
    public SelectedPlaneDetection selected;
    ...
    public void SetData(int dataIndex, PlaneDetectionCellData data, bool isVertical)
    {
